...
for (const route of routes) {
 ...
 assert(html.includes(`href="https://941novabuild.com${route}"`),route+' canonical');
...
assert((await readFile(path.join(dist,'sitemap.xml'),'utf8')).includes('https://941novabuild.com/'));
